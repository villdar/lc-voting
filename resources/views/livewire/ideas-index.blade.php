<div>
    <div class="flex flex-col space-y-3 filters md:flex-row md:space-y-0 md:space-x-6">
        ...
        <div class="w-full md:w-1/3">
            <select wire:model="filter" name="Other Filters" id="other_filters" class="w-full px-4 py-2 border-none rounded-xl">
    ...
    <div class="relative my-6 space-y-6 ideas-container">
