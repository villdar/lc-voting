<div class="relative flex mt-4 transition duration-200 ease-in bg-white border border-transparent comment-container rounded-xl">
            ...
            <div class="flex items-center justify-between mt-6">
                <div class="flex items-center space-x-2 text-xs font-semibold text-gray-400">
                    ...
                    @if ($comment->user->id === $ideaUserId)
                        <div class="px-3 py-1 uppercase bg-gray-100 border rounded-full">op</div>
                        <div>&bull;</div>
                    @endif
