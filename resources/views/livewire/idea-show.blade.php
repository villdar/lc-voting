<div class="idea-buttons-container"> <!-- Start idea-buttons-container -->
    ...
    <div class="idea-container bg-white rounded-xl flex mt-4"> <!-- start idea container -->
        ...
        <div class="flex flex-col md:flex-row flex-1 px-4 py-6">
            ...
            <div class="mx-2 md:mx-4 mt-4 md:mt-0 w-full">
    ...
    <div class="buttons-container flex items-center justify-between mt-6">
        <div class="flex flex-col md:flex-row items-center space-x-4 ml-6">
            <div class="relative" x-data="{isOpen: false}">
                ...
                <button
                    @click="isOpen = !isOpen"
                    type="button"
                    class="h-11 w-32 text-sm bg-blue font-semibold rounded-xl border border-blue hover:bg-blue-hover transition duration-150 ease-in px-6 py-3 text-white">
                        Reply
                </button>
                ...
                >
                   <form action="#" class="space-y-4 px-4 py-6">
                       ...
                       <div class="flex flex-col md:flex-row items-center md:space-x-3">
                           ...
                           <button type="button" class="h-11 w-full md:w-1/2 text-xs bg-blue font-semibold rounded-xl border border-blue hover:bg-blue-hover transition duration-150 ease-in px-6 py-3 text-white">
                               Post comment
                           </button>
                           ...
                           <button type="button" class="flex items-center justify-center w-full md:w-32 h-11 text-xs bg-gray-200 font-semibold rounded-xl border border-gray-200 hover:border-gray-400 transition duration-150 ease-in px-6 py-3 mt-2 md:mt-0">
                                <svg class="teext-gray-500 w-4 transform -rotate-45" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="hidden md:flex items-center space-x-3">
            ...
            @if ($hasVoted)
                <button
                wire:click.prevent="vote"
                type="button" class="uppercase w-32 h-11 text-xs bg-blue font-semibold rounded-xl border border-blue hover:border-blue-hover text-white transition duration-150 ease-in px-6 py-3">
                    <span>Voted</span>
                </button>
            @else
                <button
                wire:click.prevent="vote"
                type="button" class="uppercase w-32 h-11 text-xs bg-gray-200 font-semibold rounded-xl border border-gray-200 hover:border-gray-400 transition duration-150 ease-in px-6 py-3">
                    <span>Vote</span>
                </button>
            @endif
