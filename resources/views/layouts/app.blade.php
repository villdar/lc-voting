    ...
    <body class="font-sans bg-gray-background text-gray-900 text-sm">
        ...
        <main class="container mx-auto max-w-custom flex flex-col md:flex-row">
            <div class="w-70 mr-5 mx-auto md:mx-0 md:mr-5">
                <div class="bg-white md:sticky md:top-8 border-2 rounded-xl mt-16" style="
                ...
                background-clip: content-box, border-box;">
                  ...
                  @else
                    <div class="my-6 text-center">
                        <a href="{{ route('login') }}" class="inline-block justify-center w-1/2 text-xs bg-blue font-semibold rounded-xl border border-blue hover:bg-blue-hover transition duration-150 ease-in px-6 py-3 text-white">
                            Login
                        </a>
